...
while True:
    try:
        ...
        nome_arquivo = input("Informe o nome do arquivo (sem estensão): ").strip().lower()
        with open(f"44_manipulacao_arquivo_parte_03/{nome_arquivo}.txt", "w", encoding="utf-8") as f:
            f.write(novo_texto)
